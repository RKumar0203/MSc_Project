...
void analysis()
{
	...
	TFile *f = new TFile("Particle_7.7_GeV.root","READ");
	TFile *f1   = new TFile("NetKaon_7.7GeV.root","RECREATE");
	...
	TH1F *h = new TH1F("h","Net-Kaon",1734,0,1734);
