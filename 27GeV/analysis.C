...
void analysis()
{
	...
	TFile *f = new TFile("Particles_27GeV.root","READ");
	TFile *f1   = new TFile("NetKaon_27GeV.root","RECREATE");
	...
	TH1F *h = new TH1F("h","Net-Kaon",3297,0,3297);
